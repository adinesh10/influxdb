...
Exports all tsm files to line protocol.  This output file can be imported via the [influx](https://github.com/adinesh10/influxdb/tree/master/importer#running-the-import-command) command.
