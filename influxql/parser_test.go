...
func TestParser_ParseStatement(t *testing.T) {
	...
	var tests = []struct {
		...
		// SELECT statement with group by and multi digit duration (prevent regression from #731://github.com/adinesh10/influxdb/pull/7316)
		{
		...
		// See issues https://github.com/adinesh10/influxdb/issues/1647
		// and https://github.com/adinesh10/influxdb/issues/4404
		// DELETE statement
		//{
		...
		// TODO: Remove this restriction in the future: https://github.com/adinesh10/influxdb/issues/5968
		...
		// TODO: The error message will change when math is allowed inside an aggregate: https://github.com/adinesh10/influxdb/pull/5990#issuecomment-195565870
