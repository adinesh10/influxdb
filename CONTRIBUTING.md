...
You should also read our [coding guide](https://github.com/adinesh10/influxdb/blob/master/CODING_GUIDELINES.md), to understand better how to write code for InfluxDB.
...
```bash
    ...
    go get github.com/adinesh10/influxdb
```
...
-----
InfluxDB uses CircleCI for continuous integration testing. To see how the code is built and tested, check out [this file](https://github.com/adinesh10/influxdb/blob/master/circle-test.sh). It closely follows the build and test process outlined above. You can see the exact version of Go InfluxDB uses for testing by consulting that file.
